...
import jsonpickle
import logging
from keyutil import set_collection_key, set_module_key, set_play_key, set_playbook_key, set_repository_key, set_role_key, set_task_key, set_taskfile_key
...
class Module(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, module_file_path, collection_name="", role_name="", basedir=""):
    #     return load_module(module_file_path, collection_name, role_name, basedir)
...
class Collection(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, collection_dir, basedir="", load_children=True):
    #     return load_collection(collection_dir, basedir, load_children)
...
class Task(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, path, index, task_block_dict, role_name="", collection_name="", collections_in_play=[], play_index=-1, parent_key="", parent_local_key="", basedir=""):
    #     return load_task(path, index, task_block_dict, role_name, collection_name, collections_in_play, play_index, parent_key, parent_local_key, basedir)
...
class TaskFile(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, path, role_name="", collection_name="", basedir=""):
    #     return load_taskfile(path, role_name, collection_name, basedir)
...
class Role(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, path, name="", collection_name="", module_dir_paths=[], basedir="", load_children=True):
    #     return load_role(path, name, collection_name, module_dir_paths, basedir, load_children)
...
class RoleInPlay(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, name, options, defined_in, role_index, play_index, role_name="", collection_name="", collections_in_play=[], basedir=""):
    #     return load_roleinplay(name, options, defined_in, role_index, play_index, role_name, collection_name, collections_in_play, basedir)
...
class Play(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, path, index, play_block_dict, role_name="", collection_name="", parent_key="", parent_local_key="", basedir=""):
    #     return load_play(path, index, play_block_dict, role_name, collection_name, parent_key, parent_local_key, basedir)
...
class Playbook(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(path, role_name="", collection_name="", basedir=""):
    #     return load_playbook(path, role_name, collection_name, basedir)
...
class Inventory(JSONSerializable):
    ...
    # @classmethod
    # def load(cls, path, basedir=""):
    #     return load_inventory(path, basedir)
...
class Repository(JSONSerializable, Resolvable):
    ...
    # @classmethod
    # def load(cls, path="", installed_collections_path="", installed_roles_path="", my_collection_name="", basedir="", load_children=True):
    #     return load_repository(path, installed_collections_path, installed_roles_path, my_collection_name, basedir, load_children)
