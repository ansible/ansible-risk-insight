...
def set_play_key(obj, parent_key = "", parent_local_key = ""):
    ...
    global_key = "{} {}{}{}{}{}".format(type_str, _parent_key, object_delimiter, type_str, key_delimiter, index_info)
    local_key = "{} {}{}{}{}{}".format(type_str, _parent_local_key, object_delimiter, type_str, key_delimiter, index_info)
    obj.key = global_key
...
def set_task_key(obj, parent_key="", parent_local_key=""):
    ...
    _parent_key = parent_key.split(" ")[-1]
    _parent_local_key = parent_local_key.split(" ")[-1]
    global_key = "{} {}{}{}{}{}".format(obj.type, _parent_key, object_delimiter, obj.type, key_delimiter, index_info)
    local_key = "{} {}{}{}{}{}".format(obj.type, _parent_local_key, object_delimiter, obj.type, key_delimiter, index_info)
    obj.key = global_key
    obj.local_key = local_key

def set_taskfile_key(obj):
    global_key_prefix = make_global_key_prefix(obj.collection, obj.role)
    global_key = "{} {}{}{}{}".format(obj.type, global_key_prefix, obj.type, key_delimiter, obj.defined_in.lower())
    local_key = "{} {}{}{}".format(obj.type, obj.type, key_delimiter, obj.defined_in.lower())
    obj.key = global_key
    obj.local_key = local_key
